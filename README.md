...
A beautiful, modern chat website for the Emily Rivers AI influencer. Built with Next.js, React, TypeScript, and powered by Grok AI.
...
2. Update `STRIPE_SECRET_KEY` to your live key
...
Edit the `SYSTEM_PROMPT` in `app/api/chat/route.ts` to customize how Emily responds.
